...
ItemProfile.create( name: 'Lemon', kind: 2, flavor_text: "A gift from life itself.")
...
ItemProfile.create( name: 'Strawberry', kind: 2, flavor_text: "Botanically, a Strawberry is not considered a berry.")
ItemProfile.create( name: 'Blueberry', kind: 2, flavor_text: "It looks more like an Indigoberry to me.")
ItemProfile.create( name: 'Grapefruit', kind: 2, flavor_text: "I dare you to eat one without sugaring it first.")
ItemProfile.create( name: 'Indigoberry', kind: 2, flavor_text: "Wait a minute...", rarity: 5)
ItemProfile.create( name: 'Tomato', kind: 2, flavor_text: "It's technically a fruit! Look it up!")
ItemProfile.create( name: 'Banana', kind: 2, flavor_text: "Ring ring ring! Banana phone!")
ItemProfile.create( name: 'Raspberry', kind: 2, flavor_text: "What? Just one?")
ItemProfile.create( name: 'Cherry', kind: 2, flavor_text: "It's a delicious ch-ch-cherry!")