class Fablepet < ActiveRecord::Base
	...
	require 'generate_code_utilities'
	...
	public def image_url
		'/assets/fables/pets/' + self.unique_name + '.png?' + self.anti_cache
	end
	...
	public def update_image 
	    ...
	    img_string = self.image_url
	    img.write('public/assets/fables/pets/' + self.unique_name + '.png')
	    self.anti_cache = generate_code
	    self.save!
	    return img_string
	end
